...
public class FirebaseMessagingSnippets {
  ...
  public void sendToToken(String messageText) throws FirebaseMessagingException {
    // [START send_to_token]
    // This registration token comes from the client FCM SDKs.
    String registrationToken = "YOUR_REGISTRATION_TOKEN";
    ...
    // See documentation on defining a message payload.
    Message message = Message.builder()
        .putData("Game Status Update", messageText)
        .setToken(registrationToken)
        .build();
  ...
  public void sendToTokenGameStart(String registrationToken, int gameId, String otherPlayerName, int playerNumber ) throws FirebaseMessagingException {
    // [START send_to_token]
    // This registration token comes from the client FCM SDKs.
    ...
    Message message = Message.builder()
        ...
        .putData("Other Player", otherPlayerName)
        .putData("Your Player Number", String.valueOf(playerNumber))
        .setToken(registrationToken)
        .build();
  ...
  public void sendAllToStartGame(String messageString) throws FirebaseMessagingException {
...
// These registration tokens come from the client FCM SDKs.
    ...
    MulticastMessage message = MulticastMessage.builder()
        .putData("Game Starts", messageString)
